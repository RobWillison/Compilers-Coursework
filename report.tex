...
\\Todo bit on interpreter, what it supports ect
...
In order to store and call closures there is a closure structure 
One of the other fields in the union structure is the hasReturned field,
this is set when the node is a return instruction. If the has returned field is set
